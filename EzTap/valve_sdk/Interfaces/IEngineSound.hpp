...
public:
	...
	virtual int EmitSound(IRecipientFilter& filter, int iEntIndex, int iChannel, const char* pSoundEntry, unsigned int nSoundEntryHash, const char* pSample,
		...
		const Vector* pOrigin = NULL, const Vector* pDirection = NULL, void* pUtlVecOrigins = NULL, bool bUpdatePositions = true, float soundtime = 0.0f, int speakerentity = -1) = 0;
	...
	virtual void    unk() = 0;
	virtual void	GetActiveSounds(void*& sndlist) = 0;
